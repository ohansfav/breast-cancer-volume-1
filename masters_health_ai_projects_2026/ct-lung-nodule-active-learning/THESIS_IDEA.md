# Thesis Concept: ct-lung-nodule-active-learning

## Working title
Uncertainty-driven active learning for scalable lung cancer screening

## Research question
Can we improve clinical utility and trustworthiness for Lung Cancer tasks using a compact, reproducible pipeline that prioritizes calibration, sensitivity, and interpretability?
...
## Evaluation
- Primary: Label efficiency vs baseline random sampling
