# Thesis Concept: cervical-screening-selfsupervised

## Working title
Self-supervised representation learning for low-label cancer screening pipelines

## Research question
Can we improve clinical utility and trustworthiness for Screening AI tasks using a compact, reproducible pipeline that prioritizes calibration, sensitivity, and interpretability?
...
## Evaluation
- Primary: Linear probe accuracy after pretraining
